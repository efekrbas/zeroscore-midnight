...
const links = [
  {
    icon: Github,
    label: "github.com/efekrbas/zeroscore-midnight",
    href: "https://github.com/efekrbas/zeroscore-midnight",
  },
  {
    icon: Globe,
    label: "zeroscore-midnight.vercel.app",
    href: "https://zeroscore-midnight.vercel.app",
  },
